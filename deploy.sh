...
echo -e "${YELLOW}Created by IMRAN BRO${RESET}"
echo ""
...
read -p "Enter service name [default: imran-trojan]: " SERVICE_NAME
SERVICE_NAME=${SERVICE_NAME:-imran-trojan}
...
echo -e "${GREEN}[✓] URI saved to: /tmp/trojan-url.txt${RESET}"
